...
const Nptel = () => {
  ...
  const submitHandler = (e) => {
    ...
    let APIURL;
    if (state.modelOption === "model1") APIURL = model1API;
    else if (state.modelOption === "model2") APIURL = model2API;
        ...
        <div className="container">
          <div className="row nptel bg-primary">
            <div className="col-12">
              <h1 className="nptelHead">Summarization Model</h1>
            </div>
          </div>
                  ...
                  <div class="col-6">
                    <div class="form-check my-3">
                      <input
                        ...
                        type="radio"
                        value="model1"
                        checked={state.modelOption === "model1"}
                        onChange={textareaHandler}
                        name="modelOption"
                        id="model1Option"
                      />
                  ...
                  <div class="col-6">
                    <div class="form-check my-3">
                      <input
                        ...
                        type="radio"
                        value="model2"
                        checked={state.modelOption === "model2"}
                        onChange={textareaHandler}
                        name="modelOption"
                        id="model2Option"
                      />
